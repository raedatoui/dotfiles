...
export ZSH=/Users/ratoui/.oh-my-zsh
...
plugins=(git colored-man rvm ruby rvm rails colorize github jira vagrant virtualenv-prompt pip python osx zsh-syntax-highlighting)
...
alias venv=sourcePythonEnv
sourcePythonEnv() {
  source ~/work/virtualenvs/$1/bin/activate
}
...
alias flow='ls src/**/*.js | entr -cdr flow && clear'
